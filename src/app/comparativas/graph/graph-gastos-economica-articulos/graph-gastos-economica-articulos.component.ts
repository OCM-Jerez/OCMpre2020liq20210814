...
@Component({
  selector: 'app-graph-gastos-economica-articulos',
  templateUrl: './graph-gastos-economica-articulos.component.html',
  styleUrls: ['./graph-gastos-economica-articulos.component.scss']
})
export class GraphGastosEconomicaArticulosComponent implements AfterViewInit {
  ...
  async createData(eco: string) {
    ...
    this.rowData = await this.avalaibleYearsService.getDataAllYear('Eco', true);
