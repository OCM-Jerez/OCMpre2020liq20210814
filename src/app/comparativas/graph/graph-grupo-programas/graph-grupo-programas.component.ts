...
@Component({
  selector: 'app-graph-grupo-programas',
  templateUrl: './graph-grupo-programas.component.html',
  styleUrls: ['./graph-grupo-programas.component.scss']
})
export class GraphGrupoProgramasComponent implements AfterViewInit {
