...
@Component({
  selector: 'app-graph-politicas-programas',
  templateUrl: './graph-politicas-programas.component.html',
  styleUrls: ['./graph-politicas-programas.component.scss']
})
export class GraphPoliticasProgramasComponent implements AfterViewInit {
