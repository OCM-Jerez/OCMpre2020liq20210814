  ...
  ngAfterViewInit(): void {
    ...
    setTimeout(() => {
      ...
      this.options = {
        ...
        // subtitle: {
        //   text: 'Los valores de obligaciones reconocidas netas del año 2022 se igualan a los del 2021, hasta tener los datos definitivos.'
        // },
        data: [...this.data],
        series: [
          {
  ...
  async createData(pro: string) {
    ...
    for (let index = 2015; index <= 2022; index++) {
      ...
      if (index === 2022) {
        ...
        value.ObligacionesReconocidasNetas = yearsObligacionesNetas[index]
      }
