...
@Component({
  selector: 'app-graph-gastos-economica-conceptos',
  templateUrl: './graph-gastos-economica-conceptos.component.html',
  styleUrls: ['./graph-gastos-economica-conceptos.component.scss']
})
export class GraphGastosEconomicaConceptosComponent implements AfterViewInit {
